...
namespace AgroPlan.Planification.Api.Infrastructure.Migrations
{
    ...
    [Migration("20200516175242_Crop_AddMoreFields")]
    partial class Crop_AddMoreFields
    {
            ...
            modelBuilder.Entity("AgroPlan.Planification.Core.Model.Aggregate.Crop", b =>
                {
                    ...
                    b.OwnsOne("AgroPlan.Planification.Core.Model.ValueObjects.Code", "Parcel", b1 =>
                        {
                    ...
                    b.OwnsOne("AgroPlan.Planification.Core.Model.ValueObjects.Code", "PhysicalBlock", b1 =>
                        {
                            b1.Property<Guid>("CropId")
                                .HasColumnName("id")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("AgroPlan.Planification.Core.Model.ValueObjects.Code", "CropCode", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_croptypes_croptypes_id");
                        });
